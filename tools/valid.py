...
from streaknet.core import launch
...
def make_parser():
    parser = argparse.ArgumentParser("StreakNet valid")
...
def main(exp, args, num_gpu):
    ...
    assert not is_distributed, "There are unfixed bugs in multi card training!"
    ...
    evaluator = exp.get_evaluator(args.batch_size, is_distributed, args.cache, args.test)
    ...
    # start evaluate
    *_, summary = evaluator.evaluate(model, is_distributed)
    logger.info("\n" + summary)
